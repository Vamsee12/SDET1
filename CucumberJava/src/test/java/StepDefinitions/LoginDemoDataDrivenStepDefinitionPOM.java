...
public class LoginDemoDataDrivenStepDefinitionPOM {

//	WebDriver driver;
//	
//	LoginDemoDataDrivenPageObject login;
//
//	@Given("chrome browser is open")
//	public void chrome_browser_is_open() {
//		
//		System.out.println("POM Model");
//
...
//		
//		login = new LoginDemoDataDrivenPageObject(driver);
